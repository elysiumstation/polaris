...
# Using Metamask With Clockend Ethereum

In this section, we will guide you through the process of 
downloading Metamask and connecting it to a local Clockend Ethereum node. 
...
Once installed, you can then connect your Injected Metamask to your local Clockend Ethereum 
...
## Adding Clockend Ethereum Local Network
...
- Network Name: `Clockend Ethereum`
...
The Clockend Ethereum local environment is now available on your Metamask browser wallet.
